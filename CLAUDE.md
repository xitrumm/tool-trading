...
```
👀 MFI Breakout
✅AI: Dòng tiền đột biến, MFI bứt phá kèm volume cao
📥 Entry: xx - SL: xx (-xx%) - TP1: xx (+xx%) | TP2: xx (+xx%)
```
